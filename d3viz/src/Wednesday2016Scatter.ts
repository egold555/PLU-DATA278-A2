...
export class Wednesday2016Scatter extends AbstractDataViz {
    ...
    getCSVName(): string {
        return "NOAATempCyclist-2016OnlyWednesdays";
    }

    getGraphTitle(): string {
        return "Temperature and Number of Cyclists only on Wednesdays in 2016 (Scatter)";
    }
