...
export class Sunday2016 extends AbstractDataViz {
    ...
    getCSVName(): string {
        return "NOAATempCyclist-2016OnlySundays";
    }

    getGraphTitle(): string {
        return "Temperature and Number of Cyclists only on Sundays in 2016";
    }
